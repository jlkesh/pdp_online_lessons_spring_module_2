...
public class ObjectMapperTest {
    ...
    @Test
    void objectFromStringReader() throws Exception {
        String postJSON = """
                {
                  "userId": 1,
                  "id": 1,
    ...
    @Test
    void objectFromInputStream() throws Exception {
    ...
    @Test
    void objectFromStringArray() throws Exception {
        ObjectMapper mapper = new ObjectMapper();
    ...
    @Test
    void listFromStringArray() throws Exception {
        ObjectMapper mapper = new ObjectMapper();
    ...
    void mapFromStringJson() throws Exception {
        ...
        ObjectMapper mapper = new ObjectMapper();
        Map<String, String> keyvals = mapper.readValue(postJSON, new TypeReference<Map<String, String>>() {
        });
    ...
    @Test
    void unknownFieldExceptionTest() throws Exception {
        String postJson = """
                {
                   "userId": 1,
                   "id": null,
